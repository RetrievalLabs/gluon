...
- `src/languages/java/compatibility/source_scan.rs` - tree-sitter candidate collection plus required JDTLS semantic source analysis for removed, deprecated, internal, and reflective API usage.
