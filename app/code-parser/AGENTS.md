...
- `data/java/` - curated Java migration compatibility knowledge base, including removed APIs, deprecated-for-removal APIs, internal APIs, replacements, dependency compatibility, and plugin compatibility.
